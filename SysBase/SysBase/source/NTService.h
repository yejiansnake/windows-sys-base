...
namespace SysBase
{
	...
	public:		// construction/destruction
		...
		CNTService(LPCSTR lpServiceName, LPCSTR lpDisplayName = NULL, LPCSTR lpDesc = NULL);
		virtual ~CNTService();
	...
	public:		// overridables
		...
		//
		//		void CMyService :: Run(DWORD argc, LPSTR*  argv) {
		...
		virtual void Run(DWORD argc, LPSTR* argv) = 0;
	...
	protected:	// implementation
		...
		//		void CMyService :: RegisterApplicationLog(LPCSTR filename, DWORD ) {
		...
		virtual void RegisterApplicationLog(
			LPCSTR lpszProposedMessageFile,
	...
	public:	// helpers
		...
		LPSTR GetLastErrorText(LPSTR Buf, DWORD Size);
	...
	public:
		...
		BOOL ChangeService(DWORD dwServiceType);

		BOOL OsIsWin95() const { return ! m_bWinNT; }

		void SetupConsole();
		
		static CNTService* GetService();

	protected:	// data members
		LPCSTR					m_lpServiceName;
		LPCSTR					m_lpDisplayName;
		LPCSTR					m_lpDesc;
		...
		LPCSTR			m_pszLoadOrderGroup;	// default: NULL
		DWORD			m_dwTagID;				// retrieves the tag identifier
		LPCSTR			m_pszDependencies;		// default: NULL
		LPCSTR			m_pszStartName;			// default: NULL
		LPCSTR			m_pszPassword;			// default: NULL
